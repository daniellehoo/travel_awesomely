    ...
    render(){
        return(
            ...
            <div className="landing">
                ...
                <br />
                <button className="button is-primary is-hovered"><Link to='/login'>Log In</Link></button>
                <br />
                <br />
                <button className="button is-primary is-hovered"><Link to='/createaccount'>Create an account</Link></button>
                <br/>
                <Footer />
                </div>
            )
